...
public struct NowPlayingClient: Sendable {
	...
	public var remoteCommandEvents: @Sendable (_ enabledCommands: Set<RemoteCommand>) async -> AsyncStream<NowPlayingClient.RemoteCommandEvent> = { _ in AsyncStream { _ in } }
