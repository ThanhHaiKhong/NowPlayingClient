...
public struct NowPlayingClient: Sendable {
	...
	public var setupRemoteCommands: @Sendable (_ enabledCommands: Set<NowPlayingClient.RemoteCommand>, _ handlers: NowPlayingClient.RemoteCommandHandlers) async -> Void
